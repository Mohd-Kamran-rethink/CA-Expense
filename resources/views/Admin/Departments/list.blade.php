        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-3 d-flex justify-content-between align-items-centers">
                    <form action="{{ url('departments') }}" method="GET" id="search-form">
                    ...
                    <div>
                        <a href="{{ url('departments/add') }}" class="btn btn-primary">Add New Department</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <tbody>
                                        @forelse ($departments as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->userName }}</td>
                                                <td>
                                                    <button title="Delete this department"
    ...
    <div class="modal fade show" id="modal-default" style=" padding-right: 17px;" aria-modal="true" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('/departments/delete') }}" method="POST">
                    @csrf
