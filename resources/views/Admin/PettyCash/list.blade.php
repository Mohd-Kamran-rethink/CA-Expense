        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-3 d-flex justify-content-between align-items-centers">
                    <form action="{{ url('pettycash') }}" method="GET" id="search-form">
                    ...
                    <div>
                        <a href="{{ url('pettycash/add') }}" class="btn btn-primary">Add Petty Cash</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
    ...
    <div class="modal fade show" id="modal-default" style=" padding-right: 17px;" aria-modal="true" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('/pettycash/delete') }}" method="POST">
                    @csrf
