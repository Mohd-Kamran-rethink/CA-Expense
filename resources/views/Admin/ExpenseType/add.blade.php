...
<section class="content-header">
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{isset($expenseType)?url('expense-type/edit'):url('expense-type/add')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input  type="text" name="name" 
                                    class="form-control" data-validation="required" value="{{isset($expenseType)?$expenseType->name:old('name')}}">
                                    @error('name')
